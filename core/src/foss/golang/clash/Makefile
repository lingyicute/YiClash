...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/lingyicute/yiclashcore/constant.Version=$(VERSION)" \
		-X "github.com/lingyicute/yiclashcore/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
